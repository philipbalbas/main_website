module GetServerSideProps = {
  ...
  type context<'props, 'params, 'previewData> = {
    ...
    req: Req.t,
    res: Res.t,
    // TODO: Missing `resolvedUrl`, `locale`, `locales`, `defaultLocales`, `{ id: ... }`
  }
...
module GetInitialProps = {
  ...
  type t<'props, 'err> = context<'props, 'err> => Js.Promise.t<{"props": 'props}>
}
...
module Image = {
  ...
  external make: (~src: string, ~height: int, ~width: int, ~alt: string=?) => React.element =
    "default"
}
